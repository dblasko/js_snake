let gameState = (function() {
    ...
    function step() {
        ...
        if((snake[snake.length-1][0] >= world.length[0]-1 && y===1) || (snake[snake.length-1][1] >=world.length && x===1)) futureHeadLocation = undefined;
        else futureHeadLocation = world[snake[snake.length-1][0]+y][snake[snake.length-1][1]+x]; // head is at the last position of the snake array
